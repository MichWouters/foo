...
interface TrimmedIconProps {
    color?: string
}

const TrimmedIcon: FunctionComponent<TrimmedIconProps> = ({color}) => {
    return (
        <svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="scissors" style={{width: '1.5rem'}}
             className="svg-inline--fa fa-scissors " role="img" xmlns="http://www.w3.org/2000/svg"
             viewBox="0 0 512 512">
